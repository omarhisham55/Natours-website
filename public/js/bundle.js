...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    //: Add marker
    var marker = L.marker(loc.coordinates.reverse(), {
      icon: icon
    }).addTo(map);
    marker.bindPopup("Day ".concat(loc.day, ": ").concat(loc.description)).openPopup();
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type, userHeaderName) {
    var endpoint, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 4:
          ...
          if (res.data.status === "success") {
            ...
            if (userHeaderName !== res.data.data.user.name.split(" ")[0] || data.get("photo")) {
              location.reload(true);
            }
          } else {
            (0, _alerts.showAlert)("error", res.data.message);
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe("pk_test_51QpBqCLTmnBFIBAfGlRfdn4LImHYjM7da2JON3ytUsVeg3lSHCkvIdh36TTkdiuJmzqDe5LGXb9rHrkvPjCAQMg800XfCcPIeH"); //: 1. Get checkout session from API
          _context.next = 4;
...
var userHeaderName = document.getElementById("userHeaderName");
...
if (userDataForm && userHeaderName) {
  userDataForm.addEventListener("submit", function (e) {
    ...
    (0, _updateSettings.updateSettings)(form, "data", userHeaderName.innerHTML);
  });
}
if (userSettingsForm) {
